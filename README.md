...
En las instituciones educativas, la verificación de títulos, certificados o trayectos formativos suele depender de documentos PDF, constancias impresas, consultas administrativas o sistemas internos a los que terceros no siempre tienen acceso. Esto puede generar demoras, dudas sobre la autenticidad de una credencial o dependencia de intermediarios para comprobar si un certificado fue emitido por una autoridad válida y si continúa vigente.

Este proyecto propone una prueba de concepto para emitir credenciales académicas como NFTs no transferibles, asociados a una wallet del estudiante y verificables públicamente en blockchain. La emisión y revocación quedan reservadas a wallets autorizadas, mientras que cualquier persona puede consultar el estado de una credencial mediante su tokenId.

La solución no reemplaza los sistemas oficiales de gestión académica ni los registros administrativos existentes. Funciona como una capa complementaria de verificación pública: permite comprobar titularidad, existencia, fecha de emisión, hashes de respaldo y estado de validez sin exponer datos personales sensibles ni depender exclusivamente de una base de datos cerrada.
